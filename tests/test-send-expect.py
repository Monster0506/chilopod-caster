...
tests = [
  ...
  (b'GET /V HTTP/1.1\nUser-Agent: NTRIP test\n\n$GNGGA,172829.20,4332.3917404,N,00651.1321922,E,5,12,0.68,158.545,M,47.390,M,1.2,0000*62\n',
   b'^ICY 200 OK\r\n\r\n$'),
  (b'GET /V HTTP/1.1\nUser-Agent: NTRIP test\nNtrip-Version: Ntrip/2.0\n\n$GNGGA,172829.20,4332.3917404,N,00651.1321922,E,5,12,0.68,158.545,M,47.390,M,1.2,0000*62\n',
   b'^HTTP/1\.1 200 OK\r\nServer: NTRIP Chilopod Server \S+\r\nDate: .*\d\d GMT\r\nNtrip-Version: Ntrip/2\.0\r\nConnection: close\r\nContent-Type: gnss/data\r\nCache-Control: no-store, no-cache, max-age=0\r\nPragma: no-cache\r\n\r\n$'),
  ...
  (b'GET /adm/api/v1/reload?user=admin&password=%3dadminpw... HTTP/1.1\r\nContent-Length: 0\r\n\r\n',
   b'^HTTP/1\.1 405 Method Not Allowed\r\n'),
  (b'GET /adm/api/v1/reload HTTP/1.1\r\nContent-Length: 33\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\nuser=admin&password=%3dadminpw...',
   b'^HTTP/1\.1 401 Unauthorized\r\n'),
  (b'POST /adm/api/v1/xxx HTTP/1.1\r\nContent-Length: 33\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\nuser=admin&password=%3dadminpw...',
   b'^HTTP/1\.1 404 Not Found\r\n'),
